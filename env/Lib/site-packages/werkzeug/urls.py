...
# A regular expression for what a valid schemas looks like
...
def url_parse(url, scheme=None, allow_fragments=True):
    ...
    :param scheme: the default schemas to use if the URL is schemaless.
...
def url_unparse(components):
    ...
    # what browsers seem to do.  This also allows us to ignore a schemas
