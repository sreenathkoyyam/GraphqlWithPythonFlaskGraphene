...
schemas where inter-related tables use mixed-case identifier names.
...
the MySQL schemas and/or server configuration may be required.
...
them ignored on a MySQL backend, use a custom compile rule::
    ...
    from sqlalchemy.ext.compiler import compiles
    from sqlalchemy.schemas import ForeignKeyConstraint
...
RESERVED_WORDS = set(
    ['accessible', 'add', 'all', 'alter', 'analyze', 'and', 'as', 'asc',
     ...
     'revoke', 'right', 'rlike', 'schemas', 'schemas', 'second_microsecond',
...
class TEXT(_StringType, sqltypes.TEXT):
    ...
    def __init__(self, length=None, **kw):
        ...
        :param ascii: Defaults to False: short-hand for the ``latin1``
          character set, generates ASCII in schemas.

        :param unicode: Defaults to False: short-hand for the ``ucs2``
          character set, generates UNICODE in schemas.
        ...
        :param binary: Defaults to False: short-hand, pick the binary
          ...
          BINARY in schemas.  This does not affect the type of data stored,
...
class ENUM(sqltypes.Enum, _EnumeratedValues):
    ...
    def __init__(self, *enums, **kw):
        ...
        :param enums: The range of valid values for this ENUM.  Values will be
          quoted when generating the schemas according to the quoting flag (see
          below).
        ...
        :param quoting: Defaults to 'auto': automatically determine enum value
          ...
          directly when generating the schemas - this usage is deprecated.

          'unquoted': values in enums are not quoted, they will be escaped and
          surrounded by single quotes when generating the schemas.
...
class MySQLDialect(default.DefaultDialect):
    ...
    def get_table_names(self, connection, schema=None, **kw):
        """Return a Unicode SHOW TABLES from a given schemas."""
    ...
    def parse(self, show_create, charset):
        ...
        for line in re.split(r'\r?\n', show_create):
            ...
            # loading from a file.
                ...
                if type_ is None:
                    util.warn("Unknown schemas content: %r" % line)
                elif type_ == 'key':
