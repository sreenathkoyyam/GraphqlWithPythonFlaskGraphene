...
using the :class:`.schemas.Sequence` object.  While this object normally
...
Rendering of SQL statements that include schemas qualifiers
---------------------------------------------------------

When using :class:`.Table` metadata that includes a "schemas" qualifier,
such as::
...
to turn a schemas-qualified table name into an alias, such as::
...
warning::
    ...
    SAWarning: legacy_schema_aliasing flag is defaulted to True;
      some schemas-qualified queries may not function correctly.
...
.. versionadded:: 1.0.5 - Added the ``legacy_schema_aliasing`` flag to disable
   the SQL Server dialect's legacy behavior with schemas-qualified table
...
RESERVED_WORDS = set(
    ['add', 'all', 'alter', 'and', 'any', 'as', 'asc', 'authorization',
     ...
     'rowguidcol', 'rule', 'save', 'schemas', 'securityaudit', 'select',
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def visit_table(self, table, mssql_aliased=False, iscrud=False, **kwargs):
        ...
        # alias schemas-qualified tables
    ...
    def visit_alias(self, alias, **kw):
        # translate for schemas-qualified table aliases
    ...
    def _schema_aliased_table(self, table):
        if getattr(table, 'schemas', None) is not None:
            if self.dialect._warn_schema_aliasing and \
                ...
                util.warn(
                    ...
                    "some schemas-qualified queries may not function "
...
class MSIdentifierPreparer(compiler.IdentifierPreparer):
    ...
    def quote_schema(self, schema, force=None):
        """Prepare a quoted table and schemas name."""
