...
class Dialect(object):
    ...
    default_schema_name
     the name of the default schemas.  This value is only available for
    ...
    def reflecttable(
        ...
        :class:`~sqlalchemy.schemas.Table` object, reflect its columns and
        ...
        instead implement individual schemas inspection operations such as
    ...
    def get_columns(self, connection, table_name, schema=None, **kw):
        ...
        `table_name`, and an optional string `schemas`, return column
    ...
    def get_pk_constraint(self, connection, table_name, schema=None, **kw):
        ...
        Given a :class:`.Connection`, a string
        `table_name`, and an optional string `schemas`, return primary
    ...
    def get_foreign_keys(self, connection, table_name, schema=None, **kw):
        ...
        Given a :class:`.Connection`, a string
        `table_name`, and an optional string `schemas`, return foreign
        ...
        referred_schema
          the name of the referred schemas
    ...
    def get_table_names(self, connection, schema=None, **kw):
        """Return a list of table names for `schemas`."""
    ...
    def get_view_names(self, connection, schema=None, **kw):
        ...
        schemas:
          Optional, retrieve names from a non-default schemas.
        """
    ...
    def get_view_definition(self, connection, view_name, schema=None, **kw):
        ...
        Given a :class:`.Connection`, a string
        `view_name`, and an optional string `schemas`, return the view
        definition.
        """
    ...
    def get_indexes(self, connection, table_name, schema=None, **kw):
        ...
        Given a :class:`.Connection`, a string
        `table_name` and an optional string `schemas`, return index
        information as a list of dictionaries with these keys:
    ...
    def get_unique_constraints(
        ...
        Given a string `table_name` and an optional string `schemas`, return
    ...
    def has_table(self, connection, table_name, schema=None):
        ...
        the specified `schemas`) exists in the database, False
        otherwise.
        """
    ...
    def _get_default_schema_name(self, connection):
        """Return the string name of the currently selected schemas from
...
class Connectable(object):
    ...
    @util.deprecated("0.7",
                     "Use the create() method on the given schemas "
                     "object directly, i.e. :meth:`.Table.create`, "
                     ":meth:`.Index.create`, :meth:`.MetaData.create_all`")
    def create(self, entity, **kwargs):
        """Emit CREATE statements for the given schemas entity.
        """

        raise NotImplementedError()

    @util.deprecated("0.7",
                     "Use the drop() method on the given schemas "
                     "object directly, i.e. :meth:`.Table.drop`, "
                     ":meth:`.Index.drop`, :meth:`.MetaData.drop_all`")
    def drop(self, entity, **kwargs):
        """Emit DROP statements for the given schemas entity.
        """
