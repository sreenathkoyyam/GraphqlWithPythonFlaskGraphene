...
"""Provides an abstraction for obtaining database schemas information.
...
class Inspector(object):
    """Performs database schemas inspection.
    ...
    def default_schema_name(self):
        """Return the default schemas name presented by the dialect
    ...
    def get_table_names(self, schema=None, order_by=None):
        """Return all table names in referred to within a particular schemas.
        ...
        :param schema: Schema name. If ``schemas`` is left at ``None``, the
         database's default schemas is
         used, else the named schemas is searched.  If the database does not
         support named schemas, behavior is undefined if ``schemas`` is not
    ...
    def get_sorted_table_and_fkc_names(self, schema=None):
        ...
        referred to within a particular schemas.
    ...
    def get_table_options(self, table_name, schema=None, **kw):
        ...
        :param schema: string schemas name; if omitted, uses the default schemas
    ...
    def get_view_names(self, schema=None):
        """Return all view names in `schemas`.

        :param schema: Optional, retrieve names from a non-default schemas.
    ...
    def reflecttable(self, table, include_columns, exclude_columns=()):
        ...
        :param table: a :class:`~sqlalchemy.schemas.Table` instance.
