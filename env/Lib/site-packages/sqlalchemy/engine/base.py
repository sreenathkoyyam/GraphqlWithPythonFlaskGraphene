...
class Connection(Connectable):
    ...
    def _execute_default(self, default, multiparams, params):
        """Execute a schemas.ColumnDefault object."""
...
class Engine(Connectable, log.Identified):
    ...
    def execution_options(self, **opt):
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        a schemas switch or other operation, given a connection.  Below
    ...
    def has_table(self, table_name, schema=None):
        ...
        .. seealso::
            ...
            :ref:`metadata_reflection_inspector` - detailed schemas inspection
            using the :class:`.Inspector` interface.

            :class:`.quoted_name` - used to pass quoting information along
            with a schemas identifier.
