...
def literal(value, type_=None):
    ...
    such as a :class:`~sqlalchemy.schemas.Column` object.  Use this function
...
class ClauseElement(Visitable):
    ...
    def get_children(self, **kwargs):
        ...
        different context (such as schemas-level collections instead of
        clause-level).
...
class ColumnClause(Immutable, ColumnElement):
    ...
    :class:`.ColumnClause` is the immediate superclass of the schemas-specific
    ...
    the associations with schemas-level metadata or with execution-time
    ...
    def __init__(self, text, type_=None, is_literal=False, _selectable=None):
        ...
        :class:`.schemas.MetaData`, DDL, or events, unlike its
...
class quoted_name(util.MemoizedSlots, util.text_type):
    ...
    when specifying the name for key schemas constructs such as
...
class conv(_truncated_label):
    ...
    new name is applied using the :func:`.schemas.conv` marker.  We can
    ...
    Where above, the :func:`.schemas.conv` marker indicates that the constraint
