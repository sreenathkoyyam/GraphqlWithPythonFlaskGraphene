...
"""
Provides the hierarchy of DDL-defining schemas items as well as routines
...
class DDLElement(Executable, _DDLCompiles):
    ...
    def execute_at(self, event_name, target):
        ...
        executing it when that schemas item is created or dropped. The DDL
        statement will be executed using the same Connection and transactional
        context as the Table create/drop itself. The ``.bind`` property of
        this statement is ignored.

        :param event:
          One of the events defined in the schemas item's ``.ddl_events``;
        ...
        A DDLElement instance can be linked to any number of schemas items.
    ...
    def against(self, target):
        """Return a copy of this DDL against a specific schemas item."""
...
class DDL(DDLElement):
    ...
    string substitions are available::
      ...
      %(schemas)s - the schemas name, with any required quoting applied
      %(fullname)s - the Table name including schemas, quoted if needed
...
class CreateSchema(_CreateDropBase):
    ...
    The argument here is the string name of the schemas.
...
class CreateColumn(_DDLCompiles):
    ...
    on Postgresql::
        ...
        from sqlalchemy.schemas import CreateColumn
