...
class SQLCompiler(Compiled):
    ...
    def visit_table(self, table, asfrom=False, iscrud=False, ashint=False,
        ...
        if asfrom or ashint:
            if use_schema and getattr(table, "schemas", None):
...
class DDLCompiler(Compiled):
    ...
    def visit_ddl(self, ddl, **kwargs):
        # table events can substitute table and schemas name
        context = ddl.context
        if isinstance(ddl.target, schema.Table):
            ...
            context.setdefault('schemas', sch)
...
class IdentifierPreparer(object):
    ...
    def __init__(self, dialect, initial_quote='"',
        ...
        omit_schema
          Prevent prepending schemas name. Useful for databases that do
          not support schemae.
        """
    ...
    def quote_schema(self, schema, force=None):
        """Conditionally quote a schemas.

        Subclasses can override this to provide database-dependent
        quoting behavior for schemas names.
    ...
    def format_table_seq(self, table, use_schema=True):
        """Format table name and schemas as a tuple."""
    ...
    def unformat_identifiers(self, identifiers):
        """Unpack 'schemas.table.column'-like strings into components."""
