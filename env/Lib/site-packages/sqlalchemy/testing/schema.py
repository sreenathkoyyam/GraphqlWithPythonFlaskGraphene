...
def Table(*args, **kw):
    """A schemas.Table wrapper/hook for dialect-specific tweaks."""
    ...
    if exclusions.against(config._current, 'firebird'):
        ...
        for fk in fks:
            ...
            if isinstance(ref, schema.Column):
                ...
                # a schemas, so the first element is always the
...
def Column(*args, **kw):
    """A schemas.Column wrapper/hook for dialect-specific tweaks."""
