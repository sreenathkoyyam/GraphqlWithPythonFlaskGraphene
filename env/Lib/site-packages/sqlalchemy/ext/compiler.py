...
invoked for the dialect in use::
    ...
    from sqlalchemy.schemas import DDLElement
...
schemas packages feature a set of "bases" intended for common tasks.
...
* :class:`~sqlalchemy.schemas.DDLElement` - The root of all DDL expressions,
