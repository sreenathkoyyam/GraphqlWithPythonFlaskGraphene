...
def declarative_base(bind=None, metadata=None, mapper=None, cls=object,
    ...
    appropriate :class:`~sqlalchemy.schemas.Table` objects and makes
    ...
    :param bind: An optional
      ...
      the ``bind`` attribute on the :class:`~sqlalchemy.schemas.MetaData`
      instance.

    :param metadata:
      An optional :class:`~sqlalchemy.schemas.MetaData` instance.  All
      :class:`~sqlalchemy.schemas.Table` objects implicitly declared by
      subclasses of the base will share this MetaData.  A MetaData instance
      will be created if none is provided.  The
      :class:`~sqlalchemy.schemas.MetaData` instance will be available via the
