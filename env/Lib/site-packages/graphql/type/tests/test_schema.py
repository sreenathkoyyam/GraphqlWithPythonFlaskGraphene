...
def test_throws_human_readable_error_if_schematypes_not_defined():
    ...
    assert str(exci.value) == (
        "Could not find possible implementing types for Interface in schemas. Check that "
        "schemas.types is defined and is an array ofall possible types in the schemas."
    )
