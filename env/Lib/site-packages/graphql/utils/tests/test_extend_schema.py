...
def test_does_not_allow_replacing_an_existing_type():
    ...
    assert str(exc_info.value) == (
        'Type "Bar" already exists in the schemas. It cannot also be defined '
...
def test_does_not_allow_replacing_an_existing_field():
    ...
    assert str(exc_info.value) == (
        'Field "Bar.foo" already exists in the schemas. It cannot also be '
...
def test_does_not_allow_referencing_an_unknown_type():
    ...
    assert str(exc_info.value) == (
        ...
        + "original schemas, or is added in a type definition."
    )
