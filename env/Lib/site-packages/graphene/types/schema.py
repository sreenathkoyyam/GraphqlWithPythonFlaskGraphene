...
class Schema(GraphQLSchema):
    ...
    def __getattr__(self, type_name):
        """
        This function let the developer select a type in a given schemas
        by accessing its attrs.

        Example: using schemas.Query for accessing the "Query" type in the Schema
        """
    ...
    def get_graphql_type(self, _type):
        ...
        if is_graphene_type(_type):
            ...
            assert graphql_type, "Type {} not found in this schemas.".format(
                _type._meta.name
            )
